...
//        }
    ...
    private void initializeButtons(){
        ...
        fiveButton.setPosition((Gdx.graphics.getWidth() - fiveButton.getWidth())/2, ((Gdx.graphics.getHeight() * (float)0.8 + threeButton.getHeight())/2));

        sevenButton = new TextButton("7x7 Grid", skin);
        sevenButton.setPosition((Gdx.graphics.getWidth() - sevenButton.getWidth())/2, ((Gdx.graphics.getHeight() * (float)0.8 - 2 * sevenButton.getHeight())/2));

        backButton = new TextButton("Back", skin);
        backButton.setPosition((Gdx.graphics.getWidth() - sevenButton.getWidth())/2, ((Gdx.graphics.getHeight() - 5 * backButton.getHeight())/2));
    }
